...
virt-customize -a $image --run-command 'wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/x86_64/cuda-keyring_1.1-1_all.deb -O /tmp/cuda-keyring.deb'
virt-customize -a $image --run-command 'dpkg -i /tmp/cuda-keyring.deb'
echo "Upgrading packages"
virt-customize -a $image --update
echo "Installing packages"
virt-customize -a $image --install build-essential,dkms,libxml2-utils,libglvnd-core-dev,cuda-toolkit-12-9,cuda-compat-12-9,libcudnn9-cuda-12,libcudnn9-dev-cuda-12
